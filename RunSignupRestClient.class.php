...
class RunSignupRestClient
{
  ...
  * @param string $accessToken
	*/
	public function __construct($urlBase, $protocol, $apiKey = null, $apiSecret = null, $tmpKey = null, $tmpSecret = null, $accessToken = null)
	{
	...
	public function callMethod($method, $httpMethod, $getParams, $postParams, $parse = true, &$debugData = array())
	{
	  ...
	  if ($this->curl)
	  {
	  	...
	  	curl_setopt($this->curl, CURLOPT_URL, $url);
			...
			curl_setopt($this->curl, CURLOPT_CAINFO, 'cacert.pem');
